...
function sendSMS(btnObj) {
    ...
    var sendUrl = "http://zjjy.jinboai.top/tools/submit_ajax.ashx?action=user_verify_smscode";
    if ($(valObj).val() == "") {
...
function login_ok(tt) {
    ...
    $.ajax({
        type: "POST",
        url: "http://zjjy.jinboai.top/tools/submit_ajax.ashx?action=user_login_register",
...
function btn_send(reply_id) {
    ...
    $.ajax({
        type: "POST",
        url: "http://zjjy.jinboai.top/tools/submit_ajax.ashx?action=ldy_add_reply",
...
function update_head(avatar) {
    $.ajax({
        type: "POST",
        url: "http://zjjy.jinboai.top/tools/submit_ajax.ashx?action=ldy_update_head",
